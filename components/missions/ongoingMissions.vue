<template>
  <div class="tab-content active" :class="[selectedStatus === 'ongoing' ? 'active' : '']" id="ongoing-mission">
    <div class="tab-content-container infinite-loader">
      <div v-for="(client, i) in allContractsByClient" :key="`contractList${i}GroupByClient`"
        ...
        <div class="col-md-12" v-for="(mission, i) in groupBy(client, 'contract_id')" :key="`mission${i}`">
                  ...
                  <div class="col-md-12 card card-mission ch-mission">
                    ...
                    <div class="cta-container">
                      <div class="cta">
                        <ul>
                          <li>
                            <button class="btn btn-yes btn-fill full-width create-newcard" type="button">
                              Create Card
                            </button>
                          </li>
                        </ul>
...
<script type="text/javascript">
  ...
  export default {
    ...
    activated() {
      console.log('Component ongoingMissions is activated...')
    },
    deactivated() {
      console.log('Component ongoingMissions is activated...')
    },
    mounted () {
      ...
      console.log('Mounted OngoingMissions component...')
    },
    destroyed () {
      /* this.$nextTick(() => {
        this.$nuxt.$loading.start()
      ...
      console.log('Destroyed OngoingMissions component...')
    }
  }
</script>
